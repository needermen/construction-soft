...
import {WorkMainMaterialService} from "./services/work-main-material.service";
import {MainMaterialService} from "../../../../../../../admin/material/services/main-material.service";

@Component({
  selector: 'app-work-main-material',
  templateUrl: './work-main-material.component.html',
  styleUrls: ['./work-main-material.component.css']
})
export class WorkMainMaterialComponent implements OnInit, OnChanges {

  cols: any[] = [
    {
      field: 'id', header: 'მასალა', type: 'select', service: this.mainMaterialService, hideFromTable: true,
    ...
    {field: 'materialDepreciation', header: 'ცვეთა', type: 'info'},
  ...
  constructor(public service: WorkMainMaterialService, public mainMaterialService: MainMaterialService) {
  }
